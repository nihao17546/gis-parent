...
<div id="app" v-loading="loading">
    <div style="padding-left: 5px;">
        <el-button type="primary" size="small" @click="showAdd" v-if="auth.indexOf('/learn/create') != -1">新增</el-button>
        <el-input style="width: 260px;border-radius: 0px;" @keyup.enter.native="search" v-on:clear="search" v-if="auth.indexOf('/learn/list') != -1"
    ...
    <el-table
        ...
        <el-table-column
            ...
            <template slot-scope="props">
                <el-button-group>
                    <el-button type="primary" size="mini" :disabled="loading" @click="del(props.row.id)" v-if="auth.indexOf('/learn/delete') != -1">删除</el-button>
                    <el-button type="primary" size="mini" :disabled="loading" @click="showEdit(props.row)" v-if="auth.indexOf('/learn/edit') != -1">编辑</el-button>
                </el-button-group>
            </template>
        </el-table-column>
    </el-table>
...
<script>
    new Vue({
        ...
        data: {
            ...
            addVisible: false,
            iframe: 'about:blank',
            realIframe: '${contextPath}' + '/learnIframe.html',
        },
        methods: {
            showEdit(row) {
                this.tt = '新增'
            ...
            getList() {
                ...
                this.loading = true;
                axios.get('${contextPath}/learn/list',{
                    params: {
            ...
            del(id) {
                this.$confirm('确定要删除?', '提示', {
                    ...
                    this.loading = true;
                    axios.get('${contextPath}/learn/delete',{
                        params: {
                            id: id
                        }
                    }).then(res => {
